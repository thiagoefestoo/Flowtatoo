...
router.get('/:customerId', requireViewer, customerDocumentController.getCustomerDocuments);
router.post(
  '/:customerId',
  requireOperator,
...
router.delete('/:id', requireManager, customerDocumentController.deleteCustomerDocument);
