...
router.get('/:candidateId', requireViewer, candidateDocumentController.getCandidateDocuments);
router.post(
  '/:candidateId',
  requireOperator,
...
router.delete('/:id', requireManager, candidateDocumentController.deleteCandidateDocument);
