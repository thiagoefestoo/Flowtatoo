...
async function main() {
  ...
  const candidates = await Candidate.bulkCreate([
    { name: 'Ana Carolina Mendes', email: `ana.${stamp}@flowpeople.com`, phone: '(11) 90000-1001', city: 'São Paulo', state: 'SP', desiredPosition: jobs[0].title, source: 'linkedin', salaryExpectation: 5200, status: 'em_processo', stage: 'entrevista_rh', rating: 9, notes: 'Perfil aderente à vaga de RH.' },
    { name: 'Bruno Henrique Lima', email: `bruno.${stamp}@flowpeople.com`, phone: '(11) 90000-1002', city: 'Santo André', state: 'SP', desiredPosition: jobs[1].title, source: 'indicacao', salaryExpectation: 12000, status: 'em_triagem', stage: 'triagem_curricular', rating: 8, notes: 'Boa experiência técnica.' },
    { name: 'Camila Rocha', email: `camila.${stamp}@flowpeople.com`, phone: '(19) 90000-1003', city: 'Campinas', state: 'SP', desiredPosition: jobs[2].title, source: 'site', salaryExpectation: 2600, status: 'novo', stage: 'inscrito', rating: 7, notes: 'Aguardando contato inicial.' },
  ]);
  ...
  await Employee.bulkCreate([
    { name: 'Patrícia Almeida', email: `patricia.${stamp}@flowpeople.com`, phone: '(11) 90000-3001', document: `100${stamp}`, jobTitle: 'Coordenadora de RH', department: 'RH', managerName: 'Diretoria', admissionDate: new Date(), contractType: 'clt', salary: 7800, status: 'ativo' },
    { name: 'Rafael Oliveira', email: `rafael.${stamp}@flowpeople.com`, phone: '(11) 90000-3002', document: `200${stamp}`, jobTitle: 'Analista de Sistemas', department: 'Tecnologia', managerName: 'Coordenação de TI', admissionDate: new Date(), contractType: 'pj', salary: 9500, status: 'experiencia' },
  ]);
  ...
  console.log('Base de demonstração FlowPeople criada com sucesso.');
  console.log('Login: admin@flowpeople.com');
